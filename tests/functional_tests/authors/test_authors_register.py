...
class AuthorsRegisterTest(AuthorsBaseTest):
    ...
    def test_passwords_dot_not_match(self):
    ...
    def test_user_valid_data_register_sucessfully(self):
        ...
        self.get_by_placeholder(
            form, 'Type your password').send_keys('Abc12345@')
        self.get_by_placeholder(
            form, 'Repeat your password').send_keys('Abc12345@')
